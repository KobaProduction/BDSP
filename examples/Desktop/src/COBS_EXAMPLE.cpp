...
int main() {
    ...
    BDSP::streams::cobs::COBSWriterStream writer;
    BDSP::streams::cobs::COBSReaderStream reader;
    ...
    reader.set_stream_data_handler(
        [](uint8_t byte, BDSP::streams::stream_read_status_t status, void *ctx_ptr) {
            ...
            case BDSP::streams::STREAM_READER_NOT_READY_ERROR: std::cout << "Symbol: " << uint32_t(byte) << " - ERROR"; break;
            }
        },
        &context);
