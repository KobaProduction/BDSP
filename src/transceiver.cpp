...
set_config_status_t BDSPTransceiver::set_config(
    ...
    set_config_status_t status = BDSPTransmitter::set_config(cobs_config, write_handler_, write_handler_context_ptr);
