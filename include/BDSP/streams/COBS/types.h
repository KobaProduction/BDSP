...
enum set_config_status {
    ...
    WARNING_COBS_DEPTH,
    /**
     * This error occurs when the length of the sequence being replaced is less than 2 in a byte-swapping configuration.
     * Logically, you need 2 or more bytes to replace the sequence. Automatically replaces the depth value to 127.
     */
    ERROR_SIZE_SR,
    /**
     * This warning occurs when a sequence replacement algorithm is used and the length of the separator byte lookup is
